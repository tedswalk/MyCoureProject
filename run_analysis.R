...
names(combine_list) <- sub("tbodyaccjerkmag","time body acceleration jerk magnitude",names(combine_list))
names(combine_list) <- sub("tbodyaccjerk","time body acceleration jerk",names(combine_list))
names(combine_list) <- sub("tbodygyrojerkmag","time body gyroscope jerk magnitude",names(combine_list))
names(combine_list) <- sub("tbodygyrojerk","time body gyroscope jerk",names(combine_list))
names(combine_list) <- sub("tgravityaccmag","time gravity acceleration magnitude",names(combine_list))
names(combine_list) <- sub("tbodyaccmag","time body acceleration magnitude",names(combine_list))
...
names(combine_list) <- sub("tbodygyromag","time body gyroscope magnitude",names(combine_list))
...
names(combine_list) <- sub("fbodybodygyromag","frequency body body gyroscope magnitude",names(combine_list))
